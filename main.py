...
@app.get("/truckers/", response_model=List[schemas.TruckerOut], summary="Get all truckers (Requires Auth)", dependencies=[Depends(get_current_active_user)])
...
@app.get("/truckers/{trucker_id}", response_model=schemas.TruckerOutWithDocuments, summary="Get a trucker by ID (Requires Auth)", dependencies=[Depends(get_current_active_user)])
